...
use App\Models\Mrp\MrpEmployeePlaces;
...
class MrpEmployeeController extends Controller
{
    ...
    public function destroy(Request $request)
    {
        try {
            ...
            MrpInventoryProductList::where('employee_id', $request->id)->update(['employee_id' => null]);
            MrpInventoryProductIncoming::where('employee_id', $request->id)->update(['employee_id' => null]);
            MrpInventoryProductOut::where('employee_id', $request->id)->update(['employee_id' => null]);
            MrpProductSortir::where('employee_id', $request->id)->update(['employee_id' => null]);
            MrpProductSortirOK::where('employee_id', $request->id)->update(['employee_id' => null]);
            MrpProductSortirNG::where('employee_id', $request->id)->update(['employee_id' => null]);
            MrpInventoryMaterialList::where('employee_id', $request->id)->update(['employee_id' => null]);
            MrpInventoryMaterialIncoming::where('employee_id', $request->id)->update(['employee_id' => null]);
            MrpInventoryMaterialOut::where('employee_id', $request->id)->update(['employee_id' => null]);
            MrpMaterialSortir::where('employee_id', $request->id)->update(['employee_id' => null]);
            MrpMaterialSortirOK::where('employee_id', $request->id)->update(['employee_id' => null]);
            MrpMaterialSortirNG::where('employee_id', $request->id)->update(['employee_id' => null]);
            MrpPlace::where('place_id', $request->id)->update(['place_id' => null]);
            MrpEmployeePlaces::where('employee_id', $request->id)->update(['employee_id' => null]);

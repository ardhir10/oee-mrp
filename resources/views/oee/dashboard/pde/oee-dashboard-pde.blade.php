                ...
                data.forEach(d => {
                    if (d.TagGroupName === machine.name) {
                        ...
                        generateDefectRateChart('defect_rate_machine_' + machine.name, fix_val(
                            ...
                            .target_defect_rate)
                        generateEfficiencyChart('efficiency_machine_' + machine.name, 
                        
                        fix_val((
                                getValue("RunningTimeSecond", d.values) / (getValue(
                                    "RunningTimeSecond", d.values)+getValue(
                                    "AbnormalyTimeSecond", d.values))) * 100, 1), machine
                            .target_effeciency)
                    }
                });
            }

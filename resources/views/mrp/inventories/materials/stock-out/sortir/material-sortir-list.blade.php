                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action_btns d-flex">
                                            ...
                                            <a href="" onclick="deleteData(event,{{$material_sortir->id}},'{{$material_sortir->inventoryMaterialList->material->part_number}}')"  class="action_btn"> <i class="fas fa-trash"></i> </a>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach

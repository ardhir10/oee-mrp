                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action_btns d-flex"> 
                                            ...
                                            <a href="" onclick="deleteData(event,{{$material_incoming->id}},'{{$material_incoming->inventoryMaterialList->material->part_number}}')" data-toggle="tooltip" title="Delete" class="action_btn mr_10"> <i class="fas fa-trash"></i> </a>

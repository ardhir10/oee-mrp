                        ...
                        <div class="QA_table mb_30">
                            ...
                            <table class="table lms_table_active3 ">
                                ...
                                <tr>
                                    ...
                                    <td id="td1" onclick="stock('{{ $inventory_material->id }}','{{ $inventory_material->material->material_name ?? 'N/A' }}','{{ $inventory_material->stock }}','{{$inventory_material->material->id}}')">
                                        {{$inventory_material->material->material_name ?? "N/A"}}
                                    </td>
                                    ...
                                    <td>
                                        <div class="action_btns d-flex"> 
                                            ...
                                            <a href="" onclick="deleteData(event,'{{$inventory_material->id}}','{{$inventory_material->material->part_number}}')" data-toggle="tooltip" title="Delete" class="action_btn mr_10"> <i class="fas fa-trash"></i> </a>
                    ...
                    buttons: {
                        formSubmit: {
                            ...
                            action: function() {
                                ...
                                if (!material_outgoing || !employee_id ) {
                                    this.close();
                                    Swal.fire({
                                        title: 'Failed!',
                                        icon: 'error',

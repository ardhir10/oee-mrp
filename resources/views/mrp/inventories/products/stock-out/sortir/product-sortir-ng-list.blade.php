                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action_btns d-flex">
                                            ...
                                            <a href="" onclick="deleteData(event,{{$product_sortir->id}},'{{$product_sortir->inventoryProductList->product->part_number  }}')"  class="action_btn"> <i class="fas fa-trash"></i> </a>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
...
@push('js')
    ...
    <script>
        ...
        var urlDelete = `{{ route('mrp.product-sortir-delete-sortir-ng') }}`

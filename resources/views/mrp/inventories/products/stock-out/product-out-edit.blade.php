                        ...
                        <form action="{{route('mrp.product-out-update',$product_out->id)}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control delivery_id @error('delivery_shipment_id') is-invalid @enderror" name="delivery_shipment_id" onchange="selectDelivery(event)">
                                    ...
                                    @foreach ($delivery_shipments as $deliv)
                                        <option value="{{ $deliv->id }}" data-unitid="{{$deliv->customer_id}}" {{ ((old('delivery_shipment_id') ?? $deliv->id) == $deliv->id) ? 'selected' : '' }}>{{ $deliv->dn_code }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control customer_deliv @error('delivery_shipment_id') is-invalid @enderror" onchange="selectCustomer(event)">
                                    ...
                                    @foreach ($delivery_shipments as $deliv)
                                        <option value="{{ $deliv->customer_id }}" data-unitid="{{ $deliv->id }}" {{ ((old('delivery_shipment_id') ?? $deliv->customer_id) == $deliv->customer_id) ? 'selected' : '' }}>{{ $deliv->customer->customer_name }}</option>
                                    @endforeach
                                </select>
                                @error('delivery_shipment_id')
                                    <span class="invalid-feedback" role="alert">
...
<script>
    let current_stock = Number($('#current_stock').val()) + Number($('#product_outgoing').val());

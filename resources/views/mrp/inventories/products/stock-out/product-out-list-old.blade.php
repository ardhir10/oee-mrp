                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action_btns d-flex"> 
                                            ...
                                            <a href="" onclick="deleteData(event,{{$inven->id}}, '{{ $inven->productList->product->part_number }}')" data-toggle="tooltip" title="Delete" class="action_btn mr_10"> <i class="fas fa-trash"></i> </a>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach

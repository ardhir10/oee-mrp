...
<div class="row ">
    <div class="col-lg-3 col-md-6" id="material" onclick="location.href='{{ route('mrp.inventory_material-list')}}'">
        <div class="box card">
            <div class="box-body">
    ...
    <div class="col-lg-3 col-md-6" id="product" onclick="location.href='{{ route('mrp.inventory_product-list')}}'">
        <div class="box card">
            <div class="box-body">
                <div class="d-flex align-items-center">

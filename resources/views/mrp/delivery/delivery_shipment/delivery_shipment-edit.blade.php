                                        ...
                                        <select name="inventory_product_list_id" id="inventory_product_list_id"
                                            ...
                                            @foreach ($inventory_products as $inventory_product)
                                                <option value="{{ $inventory_product->id }}"
                                                    ...
                                                    {{ $inventory_product->product->part_name }} | {{ $inventory_product->product->part_number }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                @foreach ($inventory_shipments as $inventory_shipment)
                                    <tr>
                                        ...
                                        <td style="text-align:center">
                                            {{ $inventory_shipment->inventoryProductList->product->part_name }} | {{ $inventory_shipment->inventoryProductList->product->part_number }}
                                        </td>

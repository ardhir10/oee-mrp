                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('planning_id') is-invalid @enderror" onchange="setPlanning()" id="planning_id" name="planning_id" required>
                                    <option value="{{$production->planning_id}}">
                                        {{ $production->planning->plan_code }} |
                                        {{ $production->planning->plan_name }}
                                    </option>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{old('planning_name')}}" class="form-control @error('planning_name') is-invalid @enderror" id="planning_name" name="planning_name" disabled>
                                @error('planning_name')
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{old('planning_code')}}" class="form-control @error('planning_code') is-invalid @enderror" name="planning_code" id="planning_code" disabled>
                                @error('planning_code')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                                <br>
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$production->production_code}}" readonly class="form-control @error('production_code') is-invalid @enderror" id="production_code" name="production_code">
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$production->production_name}}" readonly class="form-control @error('production_name') is-invalid @enderror" id="production_name" name="production_name" required>
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <input type="text" readonly class="form-control digits minMaxExample
                                        @error('date_start') is-invalid @enderror" value="{{ $production->date_start }}" id="" name="date_start" autocomplete="off" required>
                                @error('date_start')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                                <br>
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <input type="text" readonly class="form-control digits minMaxExample
                                        @error('date_finish') is-invalid @enderror" id="" value="{{ $production->date_finish }}" name="date_finish" autocomplete="off" required>
                                @error('date_finish')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                                <br>
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" value="{{ $production->recovery_plan}}" class="form-control @error('recovery_plan') is-invalid @enderror" name="recovery_plan" id="recovery_plan" required readonly>
                                @error('recovery_plan')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                                <br>
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" value="{{ $production->target_defect_rate }}" class="form-control @error('target_defect_rate') is-invalid @enderror" name="target_defect_rate" id="target_defect_rate" required readonly>
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" value="{{ $production->target_effeciency }}" class="form-control @error('target_effeciency') is-invalid @enderror" name="target_effeciency" id="target_effeciency" required readonly>
                                ...
                                <table class="report table-bordered " style="font-size: 11px;margin-bottom:20px;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="background: {{$dataProc['type'] === 'WIP' ? '#d9dee1' : '#2CA44C'}}">
                                            ...
                                            <input type="number" value="{{$dataProc['qty_plan']}}">
                                            ...
                                            <input type="number" value="{{$ddp['qty_plan']}}">
                                            @endif
                                            @endforeach
                                        </td>
                                        @else

                                        @if (count($dataProcess) <= 1) <td>
                                            <!-- <span class="value-report " style="color:black">
                                                {{$dataProc['qty_plan']}}
                                            </span> -->
                                            <input type="number" value="{{$dataProc['qty_plan']}}">
                                    ...
                                    <tr>
                                        ...
                                        <td style="background: {{$dataProc['type'] === 'WIP' ? '#d9dee1' : '#2CA44C'}}">
                                            ...
                                            <input type="text" value="{{$dataProc['qty_total']}}">
                                            ...
                                            <input type="text" value="{{$ddp['qty_total']}}">
                                        ...
                                        @if (count($dataProcess) <= 1) <td>
                                            ...
                                            <input type="text" value="{{$ddp['qty_good']}}">
                                    ...
                                    <tr>
                                        ...
                                        <td style="background: {{$dataProc['type'] === 'WIP' ? '#d9dee1' : '#2CA44C'}}">
                                            ...
                                            <input type="text" value="{{$dataProc['qty_reject']}}">
                                            ...
                                            <input type="text" value="{{$ddp['qty_reject']}}">
                                    ...
                                    <div class="shift2">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="text" value="{{$dataProc['qty_plan']}}">
                                                {{-- chek dari oee --}}
                                                @foreach ($v2['from_oee'][$kp] as $ddp)
                                                @if ($ddp['shift_id'] === $shift->id)
                                                <!-- <span class="value-report" style="color:green">
                                                ...
                                                <input type="text" value="{{$ddp['qty_plan']}}">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="text" value="{{$dataProc['qty_good']}}">

...
const init = (io, router, cons) => {
    ...
    var allValues = [];
    var servers = [];
    const jobDatabase = schedule.scheduleJob("*/1 * * * *", function () {
        return __awaiter(this, void 0, void 0, function* () {
            var dt = datetime.create();
            var formatted = dt.format("Y-m-d H:M:S");
...
function MappingRunningTimeHourToSecond(jsonnya, TagGroupName = []) {
    ...
    if (jsonnya.TagGroupName === '16' || jsonnya.TagGroupName === '15') {
        ...
        console.log('ADANIH', runningSecond);
    }
    return jsonnya;
}
exports.default = {

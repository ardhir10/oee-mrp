...
Route::name('oee.')->middleware('auth')->group(function () {
    ...
    Route::get('/production-performance-product-out/{id}', [OeeProductionPerformanceController::class, 'detailProductOut'])->name('production-performance-product-out');
...
// Detail-Product-Out CRUD
Route::get('/get-product-out', [OeeProductionPerformanceController::class, 'getProductOut'])->name('get-product-out');
Route::get('/create-product-out', [OeeProductionPerformanceController::class, 'createProductOut'])->name('create-product-out');
Route::post('/store-product-out', [OeeProductionPerformanceController::class, 'storeProductOut'])->name('store-product-out');
Route::delete('/delete-product-out', [OeeProductionPerformanceController::class, 'deleteProductOut'])->name('delete-product-out');

...
Route::prefix('material-out')->name('mrp.material-out-')->middleware('auth')->group(function () {
    ...
    Route::get('/material-out-list-data', [MrpInventoryMaterialOutController::class, 'indexData'])->name('list-data');
...
Route::prefix('product-incoming')->name('mrp.product-incoming-')->middleware('auth')->group(function () {
    ...
    Route::get('/product-incoming-list-data', [MrpInventoryProductIncomingController::class, 'listData'])->name('list-data');
...
Route::prefix('product-out')->name('mrp.product-out-')->middleware('auth')->group(function () {
    ...
    Route::get('/product-out-list-data', [MrpInventoryProductOutController::class, 'listData'])->name('list-data');
...
// })->name('master-data.index');
    ...
    Route::prefix('import')->name('import.')->group(function () {
        ...
        Route::post('inventory-product', [MrpImportController::class, 'importFileInventoryProductList'])->name('inventory-product');
        Route::post('forecast', [MrpImportController::class, 'importFileForecast'])->name('forecast');

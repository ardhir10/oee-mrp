...
Route::get('/dashboard', [MrpDashboardProductController::class, 'index'])->name('dashboard');

Route::post('/material-chart', [MrpDashboardProductController::class, 'material_chart'])->name('material-chart');

Route::post('/material-chart-monthly', [MrpDashboardProductController::class, 'material_chart_monthly'])->name('material-chart-monthly');

Route::post('/product-chart', [MrpDashboardProductController::class, 'product_chart'])->name('product-chart');

Route::post('/product-chart-monthly', [MrpDashboardProductController::class, 'product_chart_monthly'])->name('product-chart-monthly');
